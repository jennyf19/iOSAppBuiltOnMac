...
extern void *mono_aot_module_iOSAppBuiltOnMac_iOS_info;
...
extern void *mono_aot_module_iOSAppBuiltOnMac_info;
...
{
	mono_aot_register_module (mono_aot_module_iOSAppBuiltOnMac_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_iOSAppBuiltOnMac_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "iOSAppBuiltOnMac.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
